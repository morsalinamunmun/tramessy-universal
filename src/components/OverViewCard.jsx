...
//           const diffDays = docDate.diff(today, "day");
...
//           const diffDays = partDate.diff(today, "day");
...
//           {status === "active" ? "Incurred" : "Not Incurred"}
//         </Tag>
//       ),
//     },
//   ]
...
//         <Text type="secondary" className="text-xs">No alerts</Text>
//       </div>
//     )}
//   </Card>
// </Col>
...
//                         <Tag color={item.daysLeft < 0 ? "red" : item.daysLeft <= 3 ? "red" : "orange"} className="text-xs font-medium">
//   {item.daysLeft < 0
...
//       <div className="flex flex-col items-center justify-center h-full text-gray-400">
//         <BellOutlined className="text-2xl mb-2" />
//         <Text type="secondary" className="text-xs">No upcoming bookings</Text>
//       </div>
//     )}
//   </Card>
// </Col>
...
//                         <Text strong className="text-gray-900">Total</Text>
//                       </Space>
//                     </Table.Summary.Cell>
...
//                       <Tag color="orange" className="font-medium">Total Expense</Tag>
//                     </Table.Summary.Cell>
//                   </Table.Summary.Row>
//                 )
//               }}
...
const OverViewCard = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      align: "center",
      render: (status) => (
        <Tag color={status === "active" ? "red" : "default"}>{status === "active" ? "Incurred" : "Not Incurred"}</Tag>
      ),
    },
  ]
